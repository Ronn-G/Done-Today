...
const log={
  id:'log-1',logDate:'2026-07-19',createdAt:'2026-07-19T00:00:00Z',
  updatedAt:'2026-07-19T00:00:00Z',items:[],
};
...
describe('daily log Day Theme metadata model',()=>{
  it.each([
    ...
    expect(dailyLogSchema.parse({...log,...metadata})).toMatchObject(metadata);
  ...
  it.each([
    ...
    expect(dailyLogSchema.safeParse({...log,...metadata}).success).toBe(false);
