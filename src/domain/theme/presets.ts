...
export const themePresetIds=['done-today','forest','ocean','lavender','warm-sand','monochrome'] as const;
export type ThemePresetId=(typeof themePresetIds)[number];
export interface ThemePreset{readonly id:ThemePresetId;readonly lightColors:ThemeColors;readonly darkColors:ThemeColors;readonly preview:readonly string[]}
