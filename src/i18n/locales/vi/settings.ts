export default {
  ...
  language: {
    ...
    status: {
      saving: 'Đang lưu…',
      saved: 'Đã lưu',
      error: 'Không thể lưu ngôn ngữ. Hãy thử lại.',
    },
  },
  categories: {
    heading: {
      title: 'Nhóm công việc',
      description: 'Tạo và sắp xếp các nhóm hiển thị trong bảng Hôm nay.',
    },
    create: {
      nameLabel: 'Tên nhóm mới',
      namePlaceholder: 'Tên nhóm mới',
      colorLabel: 'Màu nhóm mới',
      hexLabel: 'Mã HEX nhóm mới',
      action: 'Tạo nhóm',
    },
    status: {
    ...
    item: {
      rowLabel: 'Nhóm {{name}}',
      nameLabel: 'Tên nhóm {{name}}',
      colorLabel: 'Màu nhóm {{name}}',
