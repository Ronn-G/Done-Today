export default {
  ...
  fields: {
    ...
    nextAction: {
      ...
      placeholder: 'Tiếp theo cần làm gì?',
    },
  ...
  emptyState: {
    ...
    body: 'Chọn một nhóm bên dưới để bắt đầu ghi lại ngày hôm nay.',
  },
  addItem: {
    label: 'Thêm dòng vào',
    chooseCategory: 'Chọn nhóm…',
    accessibility: { chooseCategory: 'Chọn nhóm cho dòng mới' },
  },
  autosave: {
