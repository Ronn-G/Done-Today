export default {
  ...
  emptyState: {
    title: 'No tasks yet.',
    body: 'Choose a category below to start recording your day.',
  },
  addItem: {
    label: 'Add row to',
    chooseCategory: 'Choose a category…',
    accessibility: { chooseCategory: 'Choose a category for the new row' },
  },
  autosave: {
  ...
  backendErrors: {
    ...
    nextActionTooLong:
      'The next action must be no longer than {{max}} characters.',
