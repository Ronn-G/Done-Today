export default {
  ...
  backendErrors:{
    ...
    versionNewer:'Backup version {{version}} is newer than the supported version {{supportedVersion}}.',
    versionUnsupported:'Backup version {{version}} is not supported. Supported version: {{supportedVersion}}.',
    ...
    checksumMismatch:'The backup checksum does not match. The file may have been modified.',
    ...
    fileWriteFailed:'The backup file could not be written. Choose another location.',
    mergeUnsafe:'This backup cannot be merged safely.',
    mappingMissing:'The backup data could not be mapped for import.',
    reimportConfirmationRequired:'Confirm that you want to import this backup again.',
    receiptWriteFailed:'The import completed, but its receipt could not be prepared.',
  },
  backendWarnings:{
    appVersion:'This backup was created by Done Today {{backupVersion}}; you are using {{currentVersion}}.',
