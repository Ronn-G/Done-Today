export default {
  ...
  language: {
    ...
    option: { vi: 'Tiếng Việt', en: 'English' },
    status: {
      saving: 'Saving…',
      saved: 'Saved',
      error: 'We couldn’t save the language. Try again.',
    },
  },
  categories: {
    heading: {
      ...
      description:
        'Create and arrange the categories shown in the Today table.',
    },
    create: {
      nameLabel: 'New category name',
      namePlaceholder: 'New category name',
      colorLabel: 'New category color',
      hexLabel: 'New category HEX code',
    ...
    item: {
      ...
      nameLabel: 'Category name: {{name}}',
      colorLabel: 'Category color: {{name}}',
      moveUp: 'Move {{name}} up',
      moveDown: 'Move {{name}} down',
      hide: 'Hide category {{name}}',
      show: 'Show category {{name}}',
    },
