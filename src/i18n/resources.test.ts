...
describe('i18n resources',()=>{
  ...
  it('registers the official namespaces and required I18N-1 semantic keys',()=>{
    ...
    for(const locale of ['vi','en'] as const){
      ...
      expect(flattenResource(resources[locale].theme)).toHaveProperty('dayTheme.picker.trigger');
      expect(flattenResource(resources[locale].theme)).toHaveProperty('dayTheme.picker.saveFailed');
