...
| --- | --- | ---: | --- |
| `00-DOCUMENT-STATUS.md` | Registry và precedence | 1.1 | `eca9f76d` |
| `00-PROJECT-OVERVIEW.md` | Mục tiêu và phạm vi sản phẩm | 1.1 | `eca9f76d` |
| `01-PRODUCT-REQUIREMENTS.md` | Yêu cầu chức năng và tiêu chí MVP | 1.1 | `eca9f76d` |
...
| `05-ROADMAP.md` | Trạng thái triển khai và thứ tự công việc | 2.1 | `eca9f76d` |
